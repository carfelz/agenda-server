...
module.exports.security = {
  ...
  ***************************************************************************/
  ...
  cors: {
    ...
    allowRequestHeaders:"Access-Control-Allow-Headers,cache-control,x-requested-with,content-type,authorization,Access-Control-Allow-Origin",
    allowResponseHeaders:"Access-Control-Allow-Headers,cache-control,x-requested-with,content-type,authorization,Access-Control-Allow-Origin",
